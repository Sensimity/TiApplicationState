...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','com.sensimity.tiapplicationstate.js')
...
""" % module_assets
	...
	assets_router = os.path.join(cwd,'Classes','ComSensimityTiapplicationstateModuleAssets.m')
